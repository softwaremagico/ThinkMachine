...
import com.softwaremagico.tm.random.profiles.InvalidProfileException;
...
public class NpcFactory extends XmlFactory<Npc> {
    ...
    @Override
    public Npc getElement(String elementId, String language, String moduleName)
            throws InvalidXmlElementException {
        final Npc randomProfile = super.getElement(elementId, language, moduleName);
    ...
    protected void setParent(Npc npc, String language, String moduleName)
            throws InvalidXmlElementException {
        final String parentName = getTranslator(moduleName).getNodeValue(npc.getId(), PARENT);
        if (parentName != null && !parentName.isEmpty()) {
            try {
                final IRandomProfile parent = NpcFactory.getInstance().getElement(parentName, language,
                        moduleName);
                npc.setParent(parent);
            } catch (Exception e) {
                throw new InvalidProfileException("Invalid parent in npc '" + npc + "'.");
            }
        }
    }
    ...
    protected Npc createElement(ITranslator translator, String profileId, String name, String description,
        ...
        return new Npc(profileId, name, description, language, moduleName, preferencesSelected,
