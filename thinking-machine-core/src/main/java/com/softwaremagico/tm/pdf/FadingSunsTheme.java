...
public abstract class FadingSunsTheme {
	...
	public final static int CHARACTER_VITALITY_TITLE_FONT_SIZE = CHARACTER_SMALL_TITLE_FONT_SIZE;
	public final static int CHARACTER_VITALITY_PENALTIES_TITLE_FONT_SIZE = 7;
