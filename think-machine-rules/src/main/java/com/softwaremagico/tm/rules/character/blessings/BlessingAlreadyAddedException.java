...
import com.softwaremagico.tm.rules.character.InvalidGeneratedCharacter;
...
public class BlessingAlreadyAddedException extends InvalidGeneratedCharacter {
	...
	public BlessingAlreadyAddedException(String message) {
		super(message);
	}

	public BlessingAlreadyAddedException(String message, Exception e) {
		super(message, e);
	}
}
