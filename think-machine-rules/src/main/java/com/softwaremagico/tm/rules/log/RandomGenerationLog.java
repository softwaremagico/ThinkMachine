package com.softwaremagico.tm.rules.log;
...
public class RandomGenerationLog {

	private static final Logger logger = Logger.getLogger(RandomGenerationLog.class);

	private RandomGenerationLog() {
