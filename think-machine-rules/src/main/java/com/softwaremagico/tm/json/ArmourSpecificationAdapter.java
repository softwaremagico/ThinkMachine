...
public class ArmourSpecificationAdapter extends ElementAdapter<ArmourSpecification> {
    ...
    public ArmourSpecificationAdapter(String language, String moduleName) {
        super(language, moduleName);
    }

    @Override
    public ArmourSpecification deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext)
