...
public class AmmunitionAdapter extends ElementAdapter<Ammunition> {
    ...
    @Override
    public Ammunition deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        try {
            return AmmunitionFactory.getInstance().getElement(super.getElementId(jsonElement), super.getLanguage(), super.getModuleName());
