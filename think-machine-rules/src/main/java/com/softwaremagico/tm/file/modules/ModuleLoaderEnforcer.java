...
public class ModuleLoaderEnforcer {
    ...
    public static int loadAllFactories(String language, String moduleName) {
        ...
        futures.add(CompletableFuture.runAsync(() -> {
            try {
                //Depends on Damage Type and Shields
    ...
    public static int loadBasicFactories(String language, String moduleName) {
        ...
        final AtomicInteger loadedElements = new AtomicInteger(0);
        List<CompletableFuture<Void>> futures = new ArrayList<>();
        MachineLog.info(ModuleLoaderEnforcer.class.getName(), "Loading basic factories...");
        ...
        final long duration = (System.nanoTime() - startTime);
        MachineLog.info(ModuleLoaderEnforcer.class.getName(), "Basic factories loaded! Total {} elements loaded in {} milliseconds.",
                loadedElements.get(), duration / 1000000);
        return loadedElements.get();
    }
}
