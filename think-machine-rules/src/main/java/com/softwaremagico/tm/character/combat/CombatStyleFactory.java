...
public class CombatStyleFactory extends XmlFactory<CombatStyle> {
    ...
    protected CombatStyle createElement(ITranslator translator, String combatStyleId, String name, String description,
        ...
        try {
            ...
            for (final String combatActionId : combatActionsIds) {
                ...
                final String combatActionDescription = translator.getNodeValue(combatActionId, DESCRIPTION, language);
                ...
                final CombatAction combatAction = new CombatAction(combatActionId, combatActionName, combatActionDescription,
                        language, moduleName, combatActionGoal, combatActionDamage, combatActionOthers, requirements);
            ...
            for (final String stanceId : stancesIds) {
                ...
                final CombatStance stance = new CombatStance(stanceId, stanceName, stanceDescription, language, moduleName);
    ...
    public CombatStyle getCombatStyle(AvailableBenefice beneficeDefinition, String language, String moduleName)
            throws InvalidXmlElementException {
        if (beneficeDefinition.getBeneficeDefinition().getGroup() == BeneficeGroup.FIGHTING) {
            return getElement(beneficeDefinition.getId(), language, moduleName);
        }
        return null;
    }
}
