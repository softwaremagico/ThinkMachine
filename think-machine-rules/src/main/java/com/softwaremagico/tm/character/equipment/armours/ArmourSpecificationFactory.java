...
public class ArmourSpecificationFactory extends XmlFactory<ArmourSpecification> {
    ...
    @Override
    public FactoryCacheLoader<ArmourSpecification> getFactoryCacheLoader() {
        return null;
    }

    @Override
    protected ArmourSpecification createElement(ITranslator translator, String specificationId, String name, String description,
                                                String language, String moduleName) throws InvalidXmlElementException {
        return new ArmourSpecification(specificationId, name, description, language, moduleName);
    }
}
