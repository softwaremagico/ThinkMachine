...
public enum WeaponType {
	...
	THROWING, BOW, CROSSBOW, SLUG, MINE, MELEE, MELEE_SHIELD, MELEE_ARTIFACT, LASER, BLASTER, FLAMMER, SCREECHER, STUNNER, NEURAL, HEAVY, ROCKETEER, GRENADE, GRENADE_LAUNCHER;
