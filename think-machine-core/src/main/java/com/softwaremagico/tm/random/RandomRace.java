...
public class RandomRace extends RandomSelector<Race> {
	...
	protected RandomRace(CharacterPlayer characterPlayer, Set<IRandomPreferences> preferences) throws InvalidRaceException {
		super(characterPlayer, preferences);
	}

	public void assignRace() throws InvalidRaceException {
		getCharacterPlayer().setRace(selectElementByWeight());
	}

	@Override
	protected TreeMap<Integer, Race> assignElementsWeight() {
